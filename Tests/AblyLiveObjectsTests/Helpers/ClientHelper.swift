...
enum ClientHelper {
    ...
    private class PrefixedLogger: ARTLog {
        ...
        // We use a convenience initializer because it's not clear to a consumer of the public API how to implement a custom initializer (super.init delegates to the non-public init(capturingOutput:).

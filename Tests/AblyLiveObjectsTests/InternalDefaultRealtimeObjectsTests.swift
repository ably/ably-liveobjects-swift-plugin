...
struct InternalDefaultRealtimeObjectsTests {
    ...
    struct GetRootTests {
        ...
        func getRootThrowsIfChannelIsDetachedOrFailed(channelState: AblyPlugin.RealtimeChannelState) async throws {
            let realtimeObjects = InternalDefaultRealtimeObjectsTests.createDefaultRealtimeObjects()
    ...
    struct CreateMapTests {
        ...
        func throwsIfChannelIsInInvalidState(channelState: AblyPlugin.RealtimeChannelState) async throws {
            let realtimeObjects = InternalDefaultRealtimeObjectsTests.createDefaultRealtimeObjects()
            let coreSDK = MockCoreSDK(channelState: channelState)

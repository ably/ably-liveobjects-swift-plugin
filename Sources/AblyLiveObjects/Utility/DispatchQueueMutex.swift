...
internal final class DispatchQueueMutex<T>: Sendable {
    ...
    internal func withLock<R, E>(_ body: (inout T) throws(E) -> R) throws(E) -> R {
    ...
    internal func withoutLock<R, E>(_ body: (inout T) throws(E) -> R) throws(E) -> R {
